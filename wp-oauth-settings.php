...
<div class='wrap wpoa-settings'>
	...
	<div id="wpoa-settings-col2" class="wpoa-settings-column">
		<div id="wpoa-settings-section-about" class="wpoa-settings-section">
			<h3>About</h3>
				<p><span style="font-size:1.1em;"><strong>WP-OAuth <?php echo WPOA::PLUGIN_VERSION; ?></strong></span><br/>by <a href="emdashbuck.com" target="_blank"><strong>Dash Buck</strong></a></p>
		</div>
